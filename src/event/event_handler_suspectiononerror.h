...
#ifndef EVENT_HANDLER_SUSPECTIONONERROR__H
#define EVENT_HANDLER_SUSPECTIONONERROR__H
...
public:
    ...
    static EventHandlerSuspectionOnError defaultObject;
};
...
#endif /* EVENT_HANDLER_SUSPECTIONONERROR__H */
